...
JOYSTICK::FEATURE_CATEGORY CPeripheralAddonTranslator::TranslateFeatureCategory(JOYSTICK_FEATURE_CATEGORY category)
{
  switch (category)
  {
    case JOYSTICK_FEATURE_CATEGORY_FACE:          return JOYSTICK::FEATURE_CATEGORY::FACE;
    case JOYSTICK_FEATURE_CATEGORY_SHOULDER:      return JOYSTICK::FEATURE_CATEGORY::SHOULDER;
    case JOYSTICK_FEATURE_CATEGORY_TRIGGER:        return JOYSTICK::FEATURE_CATEGORY::TRIGGER;
    case JOYSTICK_FEATURE_CATEGORY_ANALOG_STICK:  return JOYSTICK::FEATURE_CATEGORY::ANALOG_STICK;
    case JOYSTICK_FEATURE_CATEGORY_ACCELEROMETER: return JOYSTICK::FEATURE_CATEGORY::ACCELEROMETER;
    case JOYSTICK_FEATURE_CATEGORY_HAPTICS:       return JOYSTICK::FEATURE_CATEGORY::HAPTICS;
    default:
      break;
  }
  return JOYSTICK::FEATURE_CATEGORY::UNKNOWN;
}

JOYSTICK_FEATURE_CATEGORY CPeripheralAddonTranslator::TranslateFeatureCategory(JOYSTICK::FEATURE_CATEGORY category)
{
  switch (category)
  {
    case JOYSTICK::FEATURE_CATEGORY::FACE:          return JOYSTICK_FEATURE_CATEGORY_FACE;
    case JOYSTICK::FEATURE_CATEGORY::SHOULDER:      return JOYSTICK_FEATURE_CATEGORY_SHOULDER;
    case JOYSTICK::FEATURE_CATEGORY::TRIGGER:       return JOYSTICK_FEATURE_CATEGORY_TRIGGER;
    case JOYSTICK::FEATURE_CATEGORY::ANALOG_STICK:  return JOYSTICK_FEATURE_CATEGORY_ANALOG_STICK;
    case JOYSTICK::FEATURE_CATEGORY::ACCELEROMETER: return JOYSTICK_FEATURE_CATEGORY_ACCELEROMETER;
    case JOYSTICK::FEATURE_CATEGORY::HAPTICS:       return JOYSTICK_FEATURE_CATEGORY_HAPTICS;
    default:
      break;
  }
