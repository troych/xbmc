...
#define PERIPHERAL_API_VERSION "1.1.2"
...
extern "C"
{
  ...
  typedef enum JOYSTICK_FEATURE_CATEGORY
  {
    JOYSTICK_FEATURE_CATEGORY_UNKNOWN,
    JOYSTICK_FEATURE_CATEGORY_FACE,
    JOYSTICK_FEATURE_CATEGORY_SHOULDER,
    JOYSTICK_FEATURE_CATEGORY_TRIGGER,
    JOYSTICK_FEATURE_CATEGORY_ANALOG_STICK,
    JOYSTICK_FEATURE_CATEGORY_ACCELEROMETER,
    JOYSTICK_FEATURE_CATEGORY_HAPTICS,
  } JOYSTICK_FEATURE_CATEGORY;
