...
const std::string CSettings::SETTING_GAMES_RUMBLE_NOTIFY = "gamesinput.rumblenotify";
const std::string CSettings::SETTING_GAMES_RUMBLE_DURATION = "gamesinput.rumbleduration";
const std::string CSettings::SETTING_GAMES_RUMBLE_STRONG = "gamesinput.strongmotor";
const std::string CSettings::SETTING_GAMES_RUMBLE_WEAK = "gamesinput.weakmotor";
