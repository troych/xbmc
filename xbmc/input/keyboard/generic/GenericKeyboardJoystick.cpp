...
void CGenericKeyboardJoystick::RegisterJoystickDriverHandler(JOYSTICK::IJoystickDriverHandler* handler, bool bPromiscuous)
{
...
void CGenericKeyboardJoystick::UnregisterJoystickDriverHandler(JOYSTICK::IJoystickDriverHandler* handler)
{
  CSingleLock lock(m_mutex);
